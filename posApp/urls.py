...
from .views import inventory_list, add_stock


urlpatterns = [
    path('inventory/', inventory_list, name='inventory-list'),
    path('inventory/add/<int:product_id>/', add_stock, name='add-stock'),
    path('report/download/<str:report_type>/', generate_pdf_report, name='download-report'),
    path('report/<str:report_type>/', generate_report, name="generate-report"),
